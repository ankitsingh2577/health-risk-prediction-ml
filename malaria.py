...
print(os.listdir("/Users/dilipsingh/Downloads/Healthcare-ML/malaria/cell_images/"))

data=[]
labels=[]
Parasitized=os.listdir("/Users/dilipsingh/Downloads/Healthcare-ML/malaria/cell_images/Parasitized/")
for a in Parasitized:
    try:
        image=cv2.imread("/Users/dilipsingh/Downloads/Healthcare-ML/malaria/cell_images/Parasitized/"+a)
...
Uninfected=os.listdir("/Users/dilipsingh/Downloads/Healthcare-ML/malaria/cell_images/Uninfected/")
for b in Uninfected:
    try:
        image=cv2.imread("/Users/dilipsingh/Downloads/Healthcare-ML/malaria/cell_images/Uninfected/"+b)
        image_from_array = Image.fromarray(image, 'RGB')
        size_image = image_from_array.resize((30, 30))
        data.append(np.array(size_image))
        labels.append(0)
